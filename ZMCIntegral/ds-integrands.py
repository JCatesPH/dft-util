...
print('The First Integrand: qxi = 0.001')
...
MC1 = ZMCIntegral.MCintegral(modDs_real,[[kxi,kxf],[kyi,kyf],[qxi,qxf],[qyi,qyf]])
...
print('\n========================================================')
print('\ndepth = ', MC1.depth)
print('sigma_multiplication = ', MC1.sigma_multiplication)
print('num_trials = ', MC1.num_trials)
print('available_GPU = ', MC1.available_GPU)
print('\n========================================================')
...
# Introducing second set of suggested values of integration.
...
print('The First Integrand: qxi = 0.005')
...
MC2 = ZMCIntegral.MCintegral(modDs_real,[[kxi,kxf],[kyi,kyf],[qxi,qxf],[qyi,qyf]])
...
print('\n========================================================')
print('\ndepth = ', MC2.depth)
print('sigma_multiplication = ', MC2.sigma_multiplication)
print('num_trials = ', MC2.num_trials)
print('available_GPU = ', MC2.available_GPU)
print('\n========================================================')
